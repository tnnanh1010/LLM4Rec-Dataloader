...
from evaluation import FastEvaluator, SlowEvaluator
from model.miner import Miner, NewsEncoder
...
class Trainer(BaseTrainer):
    ...
    def train(self):
        ...
        # Read data
        reader = Reader(args, tokenizer=self._tokenizer, max_title_length=args.max_title_length,
